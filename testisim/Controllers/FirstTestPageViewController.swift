//
//  FirstTestPageViewController.swift
//  testisim
//
...
class FirstTestPageViewController: UIViewController, AVSpeechSynthesizerDelegate {
        ...
        recognitionTask = speechRecognizer?.recognitionTask(with: request, resultHandler: { result, error in
            if let result = result {
                ...
                if(self.memorySpeach.lowercased().contains("devam")){
                    ...
                    self.performSegue(withIdentifier: "segueTestOneToTestTwo", sender: self)
                    ...
                    self.performSegue(withIdentifier: "segueFirstTestScreenToMainMenu", sender: self)
